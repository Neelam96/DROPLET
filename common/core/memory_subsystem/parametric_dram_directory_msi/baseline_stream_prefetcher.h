#ifndef __BASELINE_STREAM_PREFETCHER_H
#define __BASELINE_STREAM_PREFETCHER_H

#include "prefetcher.h"
#include <fstream>

class BaselineStreamPrefetcher : public Prefetcher
{
   public:
      BaselineStreamPrefetcher(String configName, core_id_t core_id, UInt32 shared_cores);
      virtual std::vector<IntPtr> getNextAddress(IntPtr current_address, core_id_t core_id);            
      ~BaselineStreamPrefetcher();
   private:
...
#endif // __BASELINE_STREAM_PREFETCHER_H