...
#define PREFETCH_MAX_QUEUE_LENGTH 100
...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheMasterCntlr
   {
      private:
         ...
         //...........................CHANGE!!!..........................
         CacheDirectoryWaiterMap m_prefetch_directory_waiters;
         //...............................................................
   ...
   class CacheCntlr : ::CacheCntlr
   {
      private:
         ...
         //..............................CHANGE!!!........................................................         
         //This function is intended to call from the L1 cache and copies data from the L3 cache into itself
         void copyDataFromLLC(Core::mem_op_t mem_op_type, IntPtr address, bool modeled, SubsecondTime t_start);        
         // This function triggers prefetches from the memory side 
         void callMemorySidePrefetch(IntPtr fake_address, SubsecondTime t_now); 
         void processExPrefetchRepFromDramDirectory(PrL1PrL2DramDirectoryMSI::ShmemMsg* shmem_msg);         
         void pushIntoL2(IntPtr address, core_id_t prefetch_dest, SubsecondTime request_issue_time, bool internal=false);    
         // this is DROPLET in L1. cache_hit and prefetch_hit do nothing
         void trainL1PropertyPrefetcher(IntPtr address, SubsecondTime t_issue, bool cache_hit=false, bool prefetch_hit=false);               
         //...............................................................................................
         ...
         void processExReqToDirectory(IntPtr address, bool isPrefetch=false); //CHANGE!!! included isPrefetch parameter 
         void processShReqToDirectory(IntPtr address, bool isPrefetch=false); //CHANGE!!! included isPrefetch parameter 
         void processUpgradeReqToDirectory(IntPtr address, ShmemPerf *perf, ShmemPerfModel::Thread_t thread_num, bool isPrefetch=false); //CHANGE!!! included isPrefetch parameter 
