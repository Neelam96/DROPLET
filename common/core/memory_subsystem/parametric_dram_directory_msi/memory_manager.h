...
namespace ParametricDramDirectoryMSI
{
   ...
   class MemoryManager : public MemoryManagerBase
   {
      ...
      public:
         ...
         //...........................................CHANGE!!!...............................................................................................
         //adding two more parameters to sendMsg: core_id_t intraTileRequester=INVALID_CORE_ID, bool isPrefetch = false
         void sendMsg(PrL1PrL2DramDirectoryMSI::ShmemMsg::msg_t msg_type, MemComponent::component_t sender_mem_component, MemComponent::component_t receiver_mem_component, core_id_t requester, core_id_t receiver, IntPtr address, Byte* data_buf = NULL, UInt32 data_length = 0, HitWhere::where_t where = HitWhere::UNKNOWN, ShmemPerf *perf = NULL, ShmemPerfModel::Thread_t thread_num = ShmemPerfModel::NUM_CORE_THREADS, core_id_t intraTileRequester=INVALID_CORE_ID, bool isPrefetch = false, 
         IntPtr fake_address=INVALID_ADDRESS);
         //.....................................................................................................................................................
