...
*/ 
BaselineStreamPrefetcher::BaselineStreamPrefetcher(String configName, core_id_t _core_id, UInt32 _shared_cores)
   : core_id(_core_id)
...
BaselineStreamPrefetcher::~BaselineStreamPrefetcher(){    
}

// This function returns prefetch addresses and updates the memory monitor region
std::vector<IntPtr> BaselineStreamPrefetcher::getPrefetchAddress(UInt32 selected_stream, std::vector<IntPtr> &prev_monitor_startAddress,
...
std::vector<IntPtr>
BaselineStreamPrefetcher::getNextAddress(IntPtr current_address, core_id_t _core_id)
{     
...
void BaselineStreamPrefetcher::printCurrentState(IntPtr current_address, std::vector<IntPtr> &prev_tracking_address,
