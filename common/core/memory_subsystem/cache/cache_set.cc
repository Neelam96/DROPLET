...
{
      //std::cout << "The block size is " << m_blocksize << std::endl;
...
{  
   if(!(offset + bytes <= m_blocksize)) std::cout << "Offset: " << offset << "  Bytes " << bytes << "   m_blocksize "<< m_blocksize << std::endl;
   //if(Sim()->getMagicServer()->inROI())std::cout << "Offset: " << offset << "  Bytes " << bytes << "   m_blocksize "<< m_blocksize << std::endl;
