   ...
   , m_writes(0)   
{
   ...
   registerStatsMetric("dram", memory_manager->getCore()->getId(), "prefetches", &m_prefetches);
   registerStatsMetric("dram", memory_manager->getCore()->getId(), "demand-reads", &m_demand_reads);
}
...
DramCntlr::getDataFromDram(IntPtr address, core_id_t requester, Byte* data_buf, SubsecondTime now, ShmemPerf *perf, bool isPrefetch)
{  
   ...
   //........................CHANGE!!!..................................
   access_t access_type = isPrefetch ? PREFETCH : READ;
   SubsecondTime dram_access_latency = runDramPerfModel(requester, now, address, access_type, perf);
   if(access_type == PREFETCH) ++m_prefetches; 
   else ++m_demand_reads;
   //......................................................................
