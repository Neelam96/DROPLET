...
namespace PrL1PrL2DramDirectoryMSI
{
   class DramCntlr : public DramCntlrInterface
   {
      private:
         ...
         UInt64 m_reads, m_writes, m_prefetches, m_demand_reads; // CHANGE!! I added prefetches 
      ...
      public:
         ...
         boost::tuple<SubsecondTime, HitWhere::where_t> getDataFromDram(IntPtr address, core_id_t requester, Byte* data_buf, SubsecondTime now, ShmemPerf *perf, bool isPrefetch = false);
