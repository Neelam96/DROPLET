...
namespace PrL1PrL2DramDirectoryMSI
{
   ShmemMsg::ShmemMsg() :
      ...
      m_data_length(0),
      m_perf(NULL),
      m_intraTileRequester(INVALID_CORE_ID), // CHANGE!!!
      m_isPrefetch(false), // CHANGE!!!
      m_fake_address(INVALID_ADDRESS) // CHANGE!!!
   {}
   ...
   ShmemMsg::ShmemMsg(msg_t msg_type,
      ...
      m_perf(perf),
      m_intraTileRequester(intraTileRequester), // CHANGE!!!
      m_isPrefetch(isPrefetch), // CHANGE!!!
      m_fake_address(fake_address) // CHANGE!!!
   {}
   ...
   ShmemMsg::ShmemMsg(ShmemMsg* shmem_msg) :
      ...
      m_intraTileRequester(shmem_msg->getIntraTileRequester()), // CHANGE!!!
      m_isPrefetch(shmem_msg->isPrefetch()), // CHANGE!!!
      m_fake_address(shmem_msg->getFakeAddress()) // CHANGE!!!
   {}
   ...
   {  
      //...............CHANGE!!!............................
      // i just add the two new types I introduced    
      switch(m_msg_type)
      {
         case EX_REQ:
         case SH_REQ:
         ...
         case INV_REP:
         case DRAM_READ_REQ:
         case DRAM_PREFETCH_REQ:
         case PREFETCH_REQ: // I added  
         case TAG_CHECK: // I added
         case TAG_CHECK_REP: // I added       
            // msg_type + address
            // msg_type - 1 byte
            return (1 + sizeof(IntPtr));

         case EX_REP:
         case EX_PREFETCH_REP: // I added         
         case SH_REP:
         case FLUSH_REP:
         case WB_REP:
         case DRAM_WRITE_REQ:
         case DRAM_READ_REP:
         case DRAM_PREFETCH_REP: // I added 
